 ...
 */
final class Version20220604073752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image_entity AS SELECT id, filename FROM image_entity');
        $this->addSql('DROP TABLE image_entity');
        $this->addSql('CREATE TABLE image_entity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, filename CLOB NOT NULL)');
        $this->addSql('INSERT INTO image_entity (id, filename) SELECT id, filename FROM __temp__image_entity');
        $this->addSql('DROP TABLE __temp__image_entity');
